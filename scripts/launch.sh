#!/bin/bash
# BRUNO — infrastructure-agnostic training launcher
#
...
#   bash <(curl -s https://codeberg.org/Ronin48/BRUNO/raw/branch/main/scripts/launch.sh)

set -e

REPO_URL="https://codeberg.org/Ronin48/BRUNO.git"
REPO_NAME="BRUNO"
